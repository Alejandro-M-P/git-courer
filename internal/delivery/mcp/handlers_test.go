...
func TestParseCommand(t *testing.T) {
	tests := []struct {
		...
		{"branch CREATE START", "BRANCH_CREATE_START", "branch", "CREATE"},
		{"branch DELETE APPLY", "BRANCH_DELETE_APPLY", "branch", "DELETE"},
...
func TestParseCommandEdgeCases(t *testing.T) {
	tests := []struct {
		...
		{"TAG_CREATE_START", "TAG_CREATE_START", "tag", "CREATE"},
		{"TAG_DELETE_APPLY", "TAG_DELETE_APPLY", "tag", "DELETE"},
